    ...
    def get_rects_for_level(self, r):
        ...
        for k in range(r + 1):
            ...
            if len(rects.submobjects) > 0:
                ...
                new_rect.next_to(self.get_center() + 0.5 *
                                 self.width * LEFT, RIGHT, buff=0)
            rects.add(new_rect)
        return rects
