...
class CompareTwoTimes(Scene):
    ...
    def show_equation(self):
        ...
        VGroup(
            VGroup(*formula[-2-seconds_len-et_len -
                            st_len:-2-seconds_len-st_len]),
...
class DsOverDtGraphically(GraphCarTrajectory, ZoomedScene):
    ...
    def construct(self):
        ...
        self.play(
            *list(map(FadeIn, [self.big_rectangle, self.little_rectangle])))
        self.play(
            ApplyFunction(
        ...
        self.play(
            ...
            UpdateFromFunc(self.little_rectangle,
                           align_little_rectangle_on_ds_dt_group),
            run_time=6,
        )
