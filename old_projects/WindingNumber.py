...
class EquationSolver1d(GraphScene, ZoomedScene):
    ...
    def solveEquation(self):
        ...
        startBrace = TexMobject("|",
                                stroke_width=10)  # TexMobject("[") # Not using [ and ] because they end up crossing over
        ...
        leftBraceLabelAnimation = ContinualChangingDecimal(leftBraceLabel,
                                                           lambda alpha: self.point_to_coords(leftBrace.get_center())[
                                                               0],
        ...
        rightBraceLabelAnimation = ContinualChangingDecimal(rightBraceLabel,
                                                            lambda alpha: self.point_to_coords(rightBrace.get_center())[
                                                                0],
        ...
        downBraceLabelAnimation = ContinualChangingDecimal(downBraceLabel,
                                                           lambda alpha: self.point_to_coords(downBrace.get_center())[
                                                                             1] + y_bias,
        ...
        upBraceLabelAnimation = ContinualChangingDecimal(upBraceLabel,
                                                         lambda alpha: self.point_to_coords(upBrace.get_center())[
                                                                           1] + y_bias,
    ...
    def construct(self):
        ...
        for i in range(len(walk_coords)):
            ...
            if self.display_wind:
                ...
                number_update_func = lambda alpha, alpha_winder=alpha_winder, start_wind=start_wind: alpha_winder(
        ...
        if self.display_odometer:
            ...
            color_wheel.color_using_background_image(
                self.short_path_to_long_path("pure_color_map.png"))  # Manually inserted here; this is unclean
...
class VectorField(Scene):
    ...
    def construct(self):
        ...
        for (x, y) in points:
            ...
            normalized_output = output * fdiv(self.normalized_arrow_scale_factor,
                                              output_size)  # Assume output has nonzero size here
...
class LoopSplitScene(ColorMappedObjectsScene):
    ...
    def construct(self):
        ...
        self.wait()
        self.play(FadeOut(inner_circle), line_fade(1, 0, midline_lines_vmobject),
                  *bullet_list_fade(1, 0, midline_bullets))
        self.wait()

        # Repeat for effect, goes well with narration
        self.play(FadeIn(inner_circle), line_fade(0, 1, midline_lines_vmobject),
