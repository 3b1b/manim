...
class FollowLinearCombination(LinearTransformationScene):
    def construct(self):
        ...
        vect_array = Matrix(
            ["x", "y"], add_background_rectangles_to_entries=True)
    ...
    def record_basis_coordinates(self, vect_array, vect):
        ...
        self.play(*[
            ...
            ShowCreation(background, run_time=2,
...
class IntroduceIdeaOfComposition(RotationThenShear):
    ...
    def show_composition(self):
        ...
        words.split()[0].set_submobject_colors_by_gradient(
            YELLOW, PINK, use_color_range_to=False)
