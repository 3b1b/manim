    ...
    def construct(self):
        ...
        for a, b, c in triples:
            ...
            if c in [5, 13, 25]:
                ...
                i_list = [i for i in range(
                    c**2) if (i % c) in keys and (i//c) in keys]
            else:
...
class VisualizeZSquared(Scene):
    ...
    def add_plane(self):
        ...
        height = (FRAME_Y_RADIUS +
                  abs(self.plane_center[1]))/self.final_unit_size
    ...
    def get_color_grid(self):
        width = (FRAME_X_RADIUS +
                 abs(self.plane_center[0]))/self.initial_unit_size
        height = (FRAME_Y_RADIUS +
                  abs(self.plane_center[1]))/self.initial_unit_size
...
class PointsWeMiss(VisualizeZSquared):
    ...
    def add_transformed_color_grid(self):
        color_grid = self.get_color_grid()
        def func(p): return self.homotopy(p[0], p[1], p[1], 1)
