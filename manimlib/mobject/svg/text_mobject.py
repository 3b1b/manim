...
class FontText(SVGMobject):
    ...
    def str2slant(self, string):
        if string == NORMAL_FONT:
            return cairo.FontSlant.NORMAL
        if string == ITALIC_FONT:
            return cairo.FontSlant.ITALIC
        if string == OBLIQUE_FONT:
    ...
    def text2svg(self):
        ...
        context.move_to(START_X_FONT, START_Y_FONT)
        ...
        for setting in settings:
            ...
            context.move_to(START_X_FONT + offset_x, START_Y_FONT + lsh*setting.line_num)
