...
class Circuito(Scene):
    def construct(self):
        p_tex="""  \\begin{circuitikz}[american]
                    ...
                    \\end{circuitikz}"""
        tex_a=TextMobject(p_tex,stroke_width=2,fill_opacity=0)
        tex_b=TextMobject(p_tex,stroke_width=0,fill_opacity=1)
        tex_c=TextMobject(p_tex,stroke_width=0,fill_opacity=1)
        excepcion=[
